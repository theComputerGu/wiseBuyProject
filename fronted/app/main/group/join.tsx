...
export default function JoinGroup() {
  ...
  const onJoin = async () => {
    if (!code.trim()) return Alert.alert("Missing code", "Please enter a group code");
    ...
    try {
      ...
      Alert.alert("Error", "Could not join group. Please check the code and try again.");
    }
  };
          ...
          <View style={styles.formSection}>
            ...
            <View style={styles.infoCard}>
              ...
              <ItimText size={13} color="#71717a" style={{ flex: 1, marginLeft: 10 }}>
                Ask your group admin for the invite code. It's usually 6 characters.
              </ItimText>
            </View>
